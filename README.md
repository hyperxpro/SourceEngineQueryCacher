...
3. Execute the following command: `java -jar SourceEngineQueryCacher-1.6.3.jar`
...
## Configuration
### Configuration File
Execute the following command to load configuration file: `java -jar SourceEngineQueryCacher-1.6.3.jar -c Config.conf`
```
...
```
### Process Arguments
Example: Execute the following command to pass Process Arguments: `java -jar SourceEngineQueryCacher-1.6.3.jar -bind 192.168.1.100 -port 27015`
```
