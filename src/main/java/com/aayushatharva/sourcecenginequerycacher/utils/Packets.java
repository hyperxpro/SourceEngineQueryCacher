...
public final class Packets {
     ...
     * FFFFFFFF41
     */
    public static final ByteBuf A2S_CHALLENGE_RESPONSE_HEADER = PooledByteBufAllocator.DEFAULT.directBuffer()
     ...
     */
    public static final ByteBuf A2S_INFO_REQUEST = PooledByteBufAllocator.DEFAULT.directBuffer()
     ...
     * FFFFFFFF49
     */
    public static final ByteBuf A2S_INFO_RESPONSE_HEADER = PooledByteBufAllocator.DEFAULT.directBuffer()
     ...
     * FFFFFFFE49
     */
    public static final ByteBuf A2S_INFO_RESPONSE_HEADER_SPLIT = PooledByteBufAllocator.DEFAULT.directBuffer()
     ...
     * FFFFFFFF5600000000
     */
    public static final ByteBuf A2S_RULES_CHALLENGE_REQUEST_1 = PooledByteBufAllocator.DEFAULT.directBuffer()
            .writeBytes(new byte[]{-1, -1, -1, -1, 86, 0, 0, 0, 0});
    public static final int A2S_RULES_CHALLENGE_REQUEST_1_LEN = 9;
    /**
     * FFFFFFFF56FFFFFFFF
     */
    public static final ByteBuf A2S_RULES_CHALLENGE_REQUEST_2 = PooledByteBufAllocator.DEFAULT.directBuffer()
     ...
     * FFFFFFFF56
     */
    public static final ByteBuf A2S_RULES_REQUEST_HEADER = PooledByteBufAllocator.DEFAULT.directBuffer()
     ...
     * FFFFFFFF45
     */
    public static final ByteBuf A2S_RULES_RESPONSE_HEADER = PooledByteBufAllocator.DEFAULT.directBuffer()
     ...
     * FFFFFFFE45
     */
    public static final ByteBuf A2S_RULES_RESPONSE_HEADER_SPLIT = PooledByteBufAllocator.DEFAULT.directBuffer()
     ...
     * FFFFFFFF5500000000
     */
    public static final ByteBuf A2S_PLAYER_CHALLENGE_REQUEST_1 = PooledByteBufAllocator.DEFAULT.directBuffer()
     ...
     * FFFFFFFF55FFFFFFFF
     */
    public static final ByteBuf A2S_PLAYER_CHALLENGE_REQUEST_2 = PooledByteBufAllocator.DEFAULT.directBuffer()
     ...
     * FFFFFFFF55
     */
    public static final ByteBuf A2S_PLAYER_REQUEST_HEADER = PooledByteBufAllocator.DEFAULT.directBuffer()
     ...
     * FFFFFFFF44
     */
    public static final ByteBuf A2S_PLAYER_RESPONSE_HEADER = PooledByteBufAllocator.DEFAULT.directBuffer()
            .writeBytes(new byte[]{-1, -1, -1, -1, 68});
    public static final int A2S_PLAYER_RESPONSE_HEADER_LEN = 5;
    /**
     * FFFFFFFE44
     */
    public static final ByteBuf A2S_PLAYER_RESPONSE_HEADER_SPLIT = PooledByteBufAllocator.DEFAULT.directBuffer()
